<script lang="ts">
  ...
  import { Connection, type Keypair, PublicKey, SystemProgram, Transaction } from "@solana/web3.js"
    ...
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
      <li class="me-2">
        <button
          ...
          class:border-transparent={selectedTab !== 'balance'}
          class:hover:text-gray-600={selectedTab !== 'balance'}
          class:hover:border-gray-300={selectedTab !== 'balance'}
          class:dark:hover:text-gray-300={selectedTab !== 'balance'}
          class:text-blue-600={selectedTab === 'balance'}
          class:border-blue-600={selectedTab === 'balance'}
          class:dark:text-blue-500={selectedTab === 'balance'}
          class:dark:border-blue-500={selectedTab === 'balance'}
          on:click={() => selectedTab = 'balance'}
        >
          Balance
        </button>
      </li>
      <li class="me-2">
        <button
          class="inline-block p-4 border-b-2 rounded-t-lg transition-colors duration-150"
          class:border-transparent={selectedTab !== 'send'}
          class:hover:text-gray-600={selectedTab !== 'send'}
          class:hover:border-gray-300={selectedTab !== 'send'}
          class:dark:hover:text-gray-300={selectedTab !== 'send'}
          class:text-blue-600={selectedTab === 'send'}
          class:border-blue-600={selectedTab === 'send'}
          class:dark:text-blue-500={selectedTab === 'send'}
          class:dark:border-blue-500={selectedTab === 'send'}
      ...
      <li class="me-2">
        <button
          class="inline-block p-4 border-b-2 rounded-t-lg transition-colors duration-150"
          class:border-transparent={selectedTab !== 'history'}
          class:hover:text-gray-600={selectedTab !== 'history'}
          class:hover:border-gray-300={selectedTab !== 'history'}
          class:dark:hover:text-gray-300={selectedTab !== 'history'}
          class:text-blue-600={selectedTab === 'history'}
          class:border-blue-600={selectedTab === 'history'}
          class:dark:text-blue-500={selectedTab === 'history'}
          class:dark:border-blue-500={selectedTab === 'history'}
...
<!--            <span class="text-gray-600 dark:text-gray-400 text-sm">Total Balance (SOL)</span>-->
<!--            <span class="font-bold text-xl text-gray-900 dark:text-white">{formatLamports(balance)}</span>-->
<!--          </div>-->
<!--          <div class="text-xs text-gray-500 dark:text-gray-500 mt-1 text-right">-->
<!--            ({balance.toLocaleString()} lamports)-->
<!--          </div>-->
<!--        </div>-->
<!--        {#if errorMessage && selectedTab === 'balance'}-->
...
<!--      </div>-->
    ...
    {#if selectedTab === 'send'}
      <div class="space-y-4">
        <div class="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-800 rounded-lg text-xs">
